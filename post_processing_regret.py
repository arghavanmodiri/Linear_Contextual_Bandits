...
#user_count = random_regrets_c.shape[0]
simulation_count = thompson_regrets_c_c.shape[1]
#simulation_count = random_regrets_c.shape[1]
...
regret_dict_c_c = {
        ...
        "r_x0_4":((regret_x0_c_c.sum(axis=1))/(simulation_count-x_c_c.sum(axis=1))).iloc[750:1000].mean(),
        "r_x1_1":((regret_x1_c_c.sum(axis=1))/x_c_c.sum(axis=1)).iloc[0:250].mean(),
        "r_x1_2":((regret_x1_c_c.sum(axis=1))/x_c_c.sum(axis=1)).iloc[250:500].mean(),
        "r_x1_3":((regret_x1_c_c.sum(axis=1))/x_c_c.sum(axis=1)).iloc[500:750].mean(),
        "r_x1_4":((regret_x1_c_c.sum(axis=1))/x_c_c.sum(axis=1)).iloc[750:1000].mean()
        }

'''regret_dict_u_c = {
        #"intercept" : thompson_ols_intercept_u_c.mean(axis=1),
        "r_1" : (thompson_regrets_u_c.mean(axis=1)).iloc[0:250].mean(),
        "r_2" : (thompson_regrets_u_c.mean(axis=1)).iloc[500:750].mean(),
        "r_x0_1":((regret_x0_u_c.sum(axis=1))/(simulation_count-x_u_c.sum(axis=1))).iloc[0:250].mean(),
        "r_x0_2":((regret_x0_u_c.sum(axis=1))/(simulation_count-x_u_c.sum(axis=1))).iloc[500:750].mean(),
        "r_x1_1":((regret_x1_u_c.sum(axis=1))/x_u_c.sum(axis=1)).iloc[0:250].mean(),
...
regret_dict_c = {
        ...
        "r_3" : (random_regrets_c.mean(axis=1)).iloc[500:750].mean(),
        "r_4" : (random_regrets_c.mean(axis=1)).iloc[750:1000].mean(),
        "r_x0_1":((regret_x0_c.sum(axis=1))/(simulation_count-x_c.sum(axis=1))).iloc[0:250].mean(),
        "r_x0_2":((regret_x0_c.sum(axis=1))/(simulation_count-x_c.sum(axis=1))).iloc[250:500].mean(),
        "r_x0_3":((regret_x0_c.sum(axis=1))/(simulation_count-x_c.sum(axis=1))).iloc[500:750].mean(),
        "r_x0_4":((regret_x0_c.sum(axis=1))/(simulation_count-x_c.sum(axis=1))).iloc[750:1000].mean(),
        "r_x1_1":((regret_x1_c.sum(axis=1))/x_c.sum(axis=1)).iloc[0:250].mean(),
...
print(interaction_size+', MAB correct, OLS correct, regret, 500-750:',
        round(regret_dict_c_c['r_3'],4))
print(interaction_size+', MAB correct, OLS correct, regret, 750-1000:',
        round(regret_dict_c_c['r_4'],4))
print(interaction_size+', MAB correct, OLS correct, regret(X=0), 0-250:',
        round(regret_dict_c_c['r_x0_1'],4))
print(interaction_size+', MAB correct, OLS correct, regret(X=0), 250-500:',
        round(regret_dict_c_c['r_x0_2'],4))
print(interaction_size+', MAB correct, OLS correct, regret(X=0), 500-750:',
        round(regret_dict_c_c['r_x0_3'],4))
print(interaction_size+', MAB correct, OLS correct, regret(X=0), 750-1000:',
        round(regret_dict_c_c['r_x0_4'],4))
print(interaction_size+', MAB correct, OLS correct, regret(X=1), 0-250:',
        round(regret_dict_c_c['r_x1_1'],4))
print(interaction_size+', MAB correct, OLS correct, regret(X=1), 250-500:',
...
#   
'''print(interaction_size+', MAB UnderSpecified, OLS correct, regret, 750-1000:',
        round(regret_dict_u_c['r_2'],2))
print(interaction_size+', MAB UnderSpecified, OLS correct, regret(X=0), 750-1000:',
        round(regret_dict_u_c['r_x0_2'],2))
print(interaction_size+', MAB UnderSpecified, OLS correct, regret(X=1), 750-1000:',
        round(regret_dict_u_c['r_x1_2'],2))'''
print("************************************************")
'''print(interaction_size+', Random, OLS correct, regret, 0-250:',
        round(regret_dict_c['r_1'],4))
print(interaction_size+', Random, OLS correct, regret, 250-500:',
        round(regret_dict_c['r_2'],4))
print(interaction_size+', Random, OLS correct, regret, 500-750:',
        round(regret_dict_c['r_3'],4))
print(interaction_size+', Random, OLS correct, regret, 750-1000:',
        round(regret_dict_c['r_4'],4))
print(interaction_size+', Random, OLS correct, regret(X=0), 0-250:',
        round(regret_dict_c['r_x0_1'],4))
print(interaction_size+', Random, OLS correct, regret(X=0), 250-500:',
        round(regret_dict_c['r_x0_2'],4))
print(interaction_size+', Random, OLS correct, regret(X=0), 500-750:',
        round(regret_dict_c['r_x0_3'],4))
print(interaction_size+', Random, OLS correct, regret(X=0), 750-1000:',
        round(regret_dict_c['r_x0_4'],4))
print(interaction_size+', Random, OLS correct, regret(X=1), 0-250:',
        round(regret_dict_c['r_x1_1'],4))
print(interaction_size+', Random, OLS correct, regret(X=1), 250-500:',
        round(regret_dict_c['r_x1_2'],4))
print(interaction_size+', Random, OLS correct, regret(X=1), 500-750:',
        round(regret_dict_c['r_x1_3'],4))
print(interaction_size+', Random, OLS correct, regret(X=1), 750-1000:',
        round(regret_dict_c['r_x1_4'],4))'''
print("************************************************")
